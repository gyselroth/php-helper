...
class HelperArrayTest extends HelperTestCase
{
    ...
    {
        self::assertFalse(HelperArray::isAssociative([
            0 => [
                'test' => 'test'
            ],
            1 => [
    ...
    {
        self::assertTrue(HelperArray::isAssociative($this->data));
    }
    ...
    public function testIsAssociativeInParts(): void
    {
        ...
        self::assertTrue(HelperArray::isAssociative($dataStructure));
    }
    ...
    {
        self::markTestSkipped('@see Application_Helper_Numeric::intExplode()');
    }
...
//    }
    ...
    public function testFlatten(): void
    {
        ...
        self::assertSame(json_encode(array_column($array, 'id')), '["200","100","300"]');
    }
    ...
    public function testConvertArrayDataByTypes()
    {
        ...
        self::assertSame(json_encode(HelperArray::convertArrayDataByTypes($array)),
    ...
    */
    ...
    public function testGetUniqueKey(): void
    {
        ...
        self::assertSame('2_1_1', HelperArray::getUniqueKey('2', $array));
    }
    ...
    */
    ...
    public function testKeys_recursive(): void
    {
        ...
        self::assertSame('a,b,c,d,e,f', implode(',', HelperArray::keysRecursive($array)));
    }
    ...
    */
    ...
    {
        self::assertFalse(HelperArray::mergeArraysByArrayIndexID(false));
    }
...
//    }
    ...
    public function testGetCsvFromArray(): void
    {
        ...
        self::assertSame('1,2,3,4', HelperArray::getCsvFromArray($array));
    }
    ...
    {
        self::markTestSkipped('@see Application_Helper_Excel::prepareDataForXLSFormat()');
    }
...
//        );
        ...
        self::assertFalse(HelperArray::hasStringKeys([0 => ['a' => 'b']]));
    }

    public function testExtendArray(): void
    {
        self::assertSame([], HelperArray::extendArray([], []));

        self::assertSame([[1, 4], [2, 5], [3, 6]], HelperArray::extendArray([1, 2, 3], [4, 5, 6]));

        $array1 = ['ids' => 98, 'titles' => 'Mr', 'names' => 'Ed'];
        $array2 = ['ids' => 99, 'titles' => 'Ms', 'names' => 'Addison'];

        self::assertSame($array2, HelperArray::extendArray([], $array2));
